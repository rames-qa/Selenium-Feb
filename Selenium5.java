...
//            WebElement title = driver.findElement(By.xpath("//h2[.='Menu']//preceding::label[4]"));
			  WebElement instuteName = driver.findElement(By.xpath("//p[.='Software Testing']/preceding-sibling::h1"));
			  WebElement anouncement = driver.findElement(By.xpath("//p[.='Software Testing']/following-sibling::p"));
